...
<head>
    ...
    <title>Escuelingo - Crear clase</title>
...
<body style="background-color: rgb(255, 255, 255);">
    ...
    <form id="form-crear-clase" autocomplete="off" name="f1" class="main-frame-form" method="post">
            ...
            <button type="button" class="btn btn-primary" name="accion" value="crear_clase" onclick="crearClase();">Crear</button>
            <button type="button" class="btn btn-secondary" onclick="redirectNuevaClase();">Volver</button>
        </form>
    </div>
